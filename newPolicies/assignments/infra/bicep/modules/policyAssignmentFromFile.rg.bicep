...
var _scopeDefault = resourceGroup().name
...
@description('Optional array of roleDefinitionIds to grant to the assignment managed identity at the resource group scope')
param roleDefinitionIds array = []

resource miRoleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for roleDefId in roleDefinitionIds: {
  name: guid(resourceGroup().id, assignment.name, roleDefId)
  properties: {
